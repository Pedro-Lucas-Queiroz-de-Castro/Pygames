...
# editor graphics 
MIN_MENU_SELECTION_INDEX = 2
MAX_MENU_SELECTION_INDEX = 18
EDITOR_DATA = {
	...
	11: {'style': 'palm_fg', 'type': 'object', 'menu': 'palm fg', 'menu_surf': '../graphics/menu/small_fg.png', 'preview': '../graphics/preview/small_fg.png', 'graphics': '../graphics/terrain/palm/small_fg', 'block': {'size': (78,55), 'offset': (0,0)}},
	12: {'style': 'palm_fg', 'type': 'object', 'menu': 'palm fg', 'menu_surf': '../graphics/menu/large_fg.png', 'preview': '../graphics/preview/large_fg.png', 'graphics': '../graphics/terrain/palm/large_fg', 'block': {'size': (78,55), 'offset': (0,0)}},
	13: {'style': 'palm_fg', 'type': 'object', 'menu': 'palm fg', 'menu_surf': '../graphics/menu/left_fg.png',  'preview': '../graphics/preview/left_fg.png',  'graphics': '../graphics/terrain/palm/left_fg', 'block': {'size': (78,55), 'offset': (0,0)}},
	14: {'style': 'palm_fg', 'type': 'object', 'menu': 'palm fg', 'menu_surf': '../graphics/menu/right_fg.png', 'preview': '../graphics/preview/right_fg.png', 'graphics': '../graphics/terrain/palm/right_fg', 'block': {'size': (78,55), 'offset': (50,0)}},
	...
	19: {'style': 'flag', 'type': 'object', 'menu': None, 'menu_surf': None, 'preview': None, 'graphics': '../graphics/flag'},
	20: {'style': 'death_line',  'type': 'object', 'menu': None, 'menu_surf': None, 'preview': None, 'graphics': None} 
}
...
DEATH_LINE_COLOR = '#bd5656'

GAME_OVER_BG_COLOR = '#040101'
VICTORY_TEXT_COLOR = '#639d6d'
FALL_DEATH_START_TEXT_COLOR = '#080b0d'
DAMAGE_DEATH_START_TEXT_COLOR = '#1b0707'

# fonts
GAME_OVER_FONT_PATH, GAME_OVER_FONT_SIZE = '../fonts/Pixelmania.ttf', 60
...
# HUD
# Heart Containers
HEART_CONTAINERS_START_X = 15
HEART_CONTAINERS_Y = 15
HEART_CONTAINERS_GAP = 15
